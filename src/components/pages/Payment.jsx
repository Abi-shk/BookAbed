...
function PaymentSucces() {
  return (
    ...
    <Link to="/" className='text-blue-800 font-extrabold mb-2'>Click here to Continue Booking<i className='bx bx-right-arrow-alt font-extrabold m-1 transition duration-300 ease-in-out'></i>
   </Link>
  </div>
